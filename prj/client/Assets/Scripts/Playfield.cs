    ...
    void Update()
    {
        ...
        switch(mState)
        {
            ...
            case STATE.PLAYGAME:
                ...
                {
                    currentCombo = 0;
                    uiAnimationObject.GetComponent<UIAnimationHandler>().ShowComboTextTimed(currentCombo);
	...
	public void AttachEggOnGrid(GameObject eggOnGrid, GameObject refBullet)
	{
        ...
        switch(refBullet.GetComponent<Bullet>().GetColor())
        {
			...
			case (int)Defines.COLOR.SPECIAL_RAINBOW:
                ...
                {                    
                    if(currentCombo > 0)
                        uiAnimationObject.GetComponent<UIAnimationHandler>().ShowComboTextTimed(0);
                    currentCombo = 0;
                }
